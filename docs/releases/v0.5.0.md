...
This release brings the Windows app to the 0.5 generation alongside Seiza for
Mac and adds the same filter-aware directory image-stacking generation powered
by the shared Seiza Rust core.
...
Version 0.5.0 supersedes it. Windows and macOS keep the same semantic-version
major, while minor and patch versions may advance independently. Existing
installations can update normally through the signed Sparkle feed.
